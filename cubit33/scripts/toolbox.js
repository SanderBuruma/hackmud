function(context, args) //t:#s.context.internal
{
    ...
    if (!args) {
        ...
        for (let u of qru) {
            q = 'order_qrs'
            dt('username:"'+u+'"')
            let a = {username:u, user: u, u:u, action:q, entry:q, navigation:q, nav:q, get:q, command:q, see:q, process:q, cmd:q}
            ...
            for (let o of oids) {
                dt('order_id:"'+o+'"')
                let a = {order_id: o, username:u, user: u, u:u, action:q, entry:q, navigation:q, nav:q, get:q, command:q, cmd:q, see:q, process:q}
